...
models:
  # ── PRIMARY: Docker MSA AI (Image icon configured) ─────────────────
  - name: "MSA AI (Docker — Recommended)"
    provider: openai
    model: msa-ai
    apiBase: http://localhost:20131/v1
    apiKey: sk-msa-local
    icon: icons/msa-ai.png
...
console.log('✅ Configuration saved with MSA AI image icon and all other icons 100% untouched!');
