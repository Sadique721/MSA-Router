...
models:
  ...
  # ── CLOUD MODELS (High-Throughput Free Tier Gemini) ─────────────────
...
fs.writeFileSync('C:\\Users\\MD SADIQUE AMIN\\.continue\\config.yaml', activeYaml, { encoding: 'utf8' });
console.log('✅ Active Continue config verified and written.');
